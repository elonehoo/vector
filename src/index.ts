type TupleShift<T extends any[]> = T extends [N: any, ...R: infer R] ? R : never[]

type VectorIndex< Curried extends number[], Rest extends number[], Value = unknown > = Rest['length'] extends 1 ? Value : SubVector<[...Curried, Rest[0]], TupleShift<Rest>, Value>

export class SubVector< Curried extends number[], Rest extends number[], Value = unknown > {
